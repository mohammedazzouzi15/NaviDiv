...
def clean_substrucuture_list(substructure_list):
    substructures_to_remove = set()
    for smart1, smart2 in itertools.combinations(substructure_list, 2):
        mol1 = Chem.MolFromSmiles(Chem.MolToSmiles(Chem.MolFromSmarts(smart1)))
        mol2 = Chem.MolFromSmiles(Chem.MolToSmiles(Chem.MolFromSmarts(smart2)))
...
def find_most_common_substructure(config):
    ...
    while not converged:
        ...
        for _ in range(
            ...
            if (
                ...
                continue
            print("size of substructures: ", len(substructures))
    ...
    print("Substructure counts:")
    print(df_substructures)
